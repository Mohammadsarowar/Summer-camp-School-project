...
const Discover = () => {
  ...
  <div className=''>
  <img className='sm:hidden md:hidden lg:inline absolute left-[-0] bottom-0 w-44 rounded-lg border-8 border-indigo-500 ' src='https://images.pexels.com/photos/4626345/pexels-photo-4626345.jpeg?auto=compress&cs=tinysrgb&w=600' ></img>
